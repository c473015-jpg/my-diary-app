...
if "todos" not in st.session_state:
    st.session_state.todos = [
        {"날짜": k_today, "시간": "10:00", "내용": "프로젝트 배포", "카테고리": "공부", "완료": True},
        {"날짜": k_today, "시간": "14:00", "내용": "전공 수업", "카테고리": "학교", "완료": False},
        {"날짜": k_today + datetime.timedelta(days=1), "시간": "18:00", "내용": "카페 파트타임", "카테고리": "알바", "완료": False},
    ]
